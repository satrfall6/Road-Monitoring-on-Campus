...
def visualize_anomalous_gird(path_in, name_of_sub_dir, grids, y_test, y_pred , video_info_test, X_BLOCK_SIZE = 30, Y_BLOCK_SIZE = 30):
...
def visualize_dense_anomalous_gird(path_in, name_of_sub_dir, grids, y_test, y_pred , video_info_test, motion_threshold=0.95, X_BLOCK_SIZE = 30, Y_BLOCK_SIZE = 30):
...
#for d in sub_dir_ucsd_test:
    d = 'Test014'
    visualize_anomalous_gird(test_video_path, d, grids, y_test, y_pred , video_info_test, X_BLOCK_SIZE = 30, Y_BLOCK_SIZE = 30)
#%%
#for d in sub_dir_ucsd_test:
#    d = 'Test025'
    d = 'Test020'
